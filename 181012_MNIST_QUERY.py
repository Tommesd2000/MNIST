...
for image_file_name in glob.glob('//vmware-host/Shared Folders/Workstation-Data/Service/Research/AI/Data/MNIST/custom/2828_my_own_origd_5.png'):
    ...
    # query the network
    n.wih = numpy.genfromtxt("//vmware-host/Shared Folders/Workstation-Data/Service/Research/AI/Data/MNIST/model/wih.csv", delimiter=',')
    n.who = numpy.genfromtxt("//vmware-host/Shared Folders/Workstation-Data/Service/Research/AI/Data/MNIST/model/who.csv", delimiter=',')
